...
trainer_params = {
    ...
    'use_autocast': True,
    'seed': 1234,
    'config_name': 'train_'+env_params['problem_type']+'_n'+str(env_params['problem_size'])+'_mvmoe',
    'logging': {
...
logger_params = {
    'log_file': {
        'desc': 'train_'+env_params['problem_type']+'_n'+str(env_params['problem_size'])+'_mvmoe',
        'filename': 'run_log'
    }
}
